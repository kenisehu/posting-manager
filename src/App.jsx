...
const MUNICIPALITIES_DATA = [
  // 埼玉県
  { id: 1, prefecture: "埼玉県", name: "さいたま市", households: 640000 },
  { id: 2, prefecture: "埼玉県", name: "川口市", households: 302000 },
  { id: 3, prefecture: "埼玉県", name: "川越市", households: 167000 },
  { id: 4, prefecture: "埼玉県", name: "所沢市", households: 169000 },
  { id: 5, prefecture: "埼玉県", name: "越谷市", households: 162000 },
  { id: 6, prefecture: "埼玉県", name: "草加市", households: 125000 },
  { id: 7, prefecture: "埼玉県", name: "春日部市", households: 112000 },
  { id: 8, prefecture: "埼玉県", name: "上尾市", households: 108000 },
  { id: 9, prefecture: "埼玉県", name: "熊谷市", households: 90000 },
  { id: 10, prefecture: "埼玉県", name: "朝霞市", households: 71000 },
  { id: 11, prefecture: "埼玉県", name: "新座市", households: 79000 },
  { id: 12, prefecture: "埼玉県", name: "狭山市", households: 72000 },
  { id: 13, prefecture: "埼玉県", name: "入間市", households: 65000 },
  { id: 14, prefecture: "埼玉県", name: "久喜市", households: 69000 },
  { id: 15, prefecture: "埼玉県", name: "鴻巣市", households: 53000 },
  { id: 16, prefecture: "埼玉県", name: "深谷市", households: 63000 },
  { id: 17, prefecture: "埼玉県", name: "三郷市", households: 68000 },
  { id: 18, prefecture: "埼玉県", name: "富士見市", households: 55000 },
  { id: 19, prefecture: "埼玉県", name: "ふじみ野市", households: 55000 },
  { id: 20, prefecture: "埼玉県", name: "戸田市", households: 69000 },
  { id: 21, prefecture: "埼玉県", name: "蕨市", households: 41000 },
  { id: 22, prefecture: "埼玉県", name: "和光市", households: 44000 },
  { id: 23, prefecture: "埼玉県", name: "志木市", households: 36000 },
  { id: 24, prefecture: "埼玉県", name: "桶川市", households: 32000 },
  { id: 25, prefecture: "埼玉県", name: "北本市", households: 31000 },
  { id: 26, prefecture: "埼玉県", name: "行田市", households: 36000 },
  { id: 27, prefecture: "埼玉県", name: "加須市", households: 50000 },
  ...
  { id: 31, prefecture: "埼玉県", name: "坂戸市", households: 48000 },
  { id: 32, prefecture: "埼玉県", name: "東松山市", households: 43000 },
  ...
  { id: 40, prefecture: "埼玉県", name: "秩父市", households: 26000 },
  ...
  { id: 55, prefecture: "埼玉県", name: "蓮田市", households: 28000 },
  { id: 56, prefecture: "埼玉県", name: "幸手市", households: 22000 },
  { id: 57, prefecture: "埼玉県", name: "八潮市", households: 46000 },
  { id: 58, prefecture: "埼玉県", name: "吉川市", households: 31000 },
  { id: 59, prefecture: "埼玉県", name: "伊奈町", households: 21000 },
  { id: 160, prefecture: "埼玉県", name: "飯能市", households: 37000 },
  ...
  // 栃木県
  { id: 60, prefecture: "栃木県", name: "宇都宮市", households: 245000 },
  { id: 61, prefecture: "栃木県", name: "小山市", households: 76000 },
  ...
  { id: 69, prefecture: "栃木県", name: "那須塩原市", households: 53000 },
  { id: 70, prefecture: "栃木県", name: "真岡市", households: 33000 },
  ...
  { id: 75, prefecture: "栃木県", name: "茂木町", households: 5000 },
  { id: 76, prefecture: "栃木県", name: "市貝町", households: 6000 },
  { id: 77, prefecture: "栃木県", name: "芳賀町", households: 6000 },
  { id: 78, prefecture: "栃木県", name: "壬生町", households: 17000 },
  ...
  { id: 82, prefecture: "栃木県", name: "那須町", households: 11000 },
  { id: 83, prefecture: "栃木県", name: "那珂川町", households: 6000 },
  { id: 164, prefecture: "栃木県", name: "さくら市", households: 18000 },
  // 茨城県
  { id: 84, prefecture: "茨城県", name: "水戸市", households: 126000 },
  { id: 85, prefecture: "茨城県", name: "つくば市", households: 121000 },
  { id: 86, prefecture: "茨城県", name: "日立市", households: 77000 },
  { id: 87, prefecture: "茨城県", name: "古河市", households: 60000 },
  { id: 88, prefecture: "茨城県", name: "ひたちなか市", households: 69000 },
  ...
  { id: 92, prefecture: "茨城県", name: "鹿嶋市", households: 29000 },
  { id: 93, prefecture: "茨城県", name: "神栖市", households: 41000 },
  { id: 94, prefecture: "茨城県", name: "筑西市", households: 39000 },
  { id: 95, prefecture: "茨城県", name: "常総市", households: 24000 },
  ...
  { id: 101, prefecture: "茨城県", name: "稲敷市", households: 15000 },
  { id: 102, prefecture: "茨城県", name: "鉾田市", households: 20000 },
  { id: 103, prefecture: "茨城県", name: "行方市", households: 11000 },
  { id: 104, prefecture: "茨城県", name: "小美玉市", households: 20000 },
  { id: 105, prefecture: "茨城県", name: "桜川市", households: 14000 },
  ...
  { id: 110, prefecture: "茨城県", name: "北茨城市", households: 17000 },
  { id: 111, prefecture: "茨城県", name: "高萩市", households: 12000 },
  { id: 112, prefecture: "茨城県", name: "潮来市", households: 11000 },
  { id: 113, prefecture: "茨城県", name: "茨城町", households: 13000 },
  { id: 114, prefecture: "茨城県", name: "大洗町", households: 7000 },
  { id: 115, prefecture: "茨城県", name: "城里町", households: 7000 },
  { id: 116, prefecture: "茨城県", name: "東海村", households: 17000 },
  { id: 117, prefecture: "茨城県", name: "大子町", households: 6000 },
  { id: 118, prefecture: "茨城県", name: "阿見町", households: 22000 },
  { id: 119, prefecture: "茨城県", name: "美浦村", households: 5000 },
  { id: 120, prefecture: "茨城県", name: "河内町", households: 3000 },
  { id: 121, prefecture: "茨城県", name: "八千代町", households: 7000 },
  { id: 122, prefecture: "茨城県", name: "五霞町", households: 3000 },
  { id: 123, prefecture: "茨城県", name: "境町", households: 9000 },
  { id: 124, prefecture: "茨城県", name: "利根町", households: 7000 },
  { id: 165, prefecture: "茨城県", name: "結城市", households: 20000 },
  { id: 166, prefecture: "茨城県", name: "下妻市", households: 17000 },
  { id: 167, prefecture: "茨城県", name: "かすみがうら市", households: 17000 },
  // 群馬県
  { id: 125, prefecture: "群馬県", name: "前橋市", households: 155000 },
  { id: 126, prefecture: "群馬県", name: "高崎市", households: 172000 },
  { id: 127, prefecture: "群馬県", name: "桐生市", households: 49000 },
  { id: 128, prefecture: "群馬県", name: "伊勢崎市", households: 96000 },
  { id: 129, prefecture: "群馬県", name: "太田市", households: 101000 },
  ...
  { id: 137, prefecture: "群馬県", name: "榛東村", households: 6000 },
  ...
  { id: 143, prefecture: "群馬県", name: "甘楽町", households: 5000 },
  { id: 144, prefecture: "群馬県", name: "中之条町", households: 7000 },
  ...
  { id: 149, prefecture: "群馬県", name: "東吾妻町", households: 5000 },
  ...
  { id: 154, prefecture: "群馬県", name: "玉村町", households: 16000 },
  { id: 155, prefecture: "群馬県", name: "板倉町", households: 6000 },
  { id: 156, prefecture: "群馬県", name: "明和町", households: 4000 },
  { id: 157, prefecture: "群馬県", name: "千代田町", households: 5000 },
  { id: 158, prefecture: "群馬県", name: "大泉町", households: 20000 },
  { id: 159, prefecture: "群馬県", name: "邑楽町", households: 11000 },
];
...
const BADGE_DEFS = [
  // 投函枚数（6段階）
  { id: "flyer_300",   category: "投函枚数", catIcon: "📮", rank: 1, icon: "📬", label: "ポスター見習い",   desc: "累計300枚投函",    color: "#94a3b8", check: s => s.totalFlyers >= 300 },
  { id: "flyer_700",   category: "投函枚数", catIcon: "📮", rank: 2, icon: "📮", label: "配達人",           desc: "累計700枚投函",    color: "#cd7f32", check: s => s.totalFlyers >= 700 },
  { id: "flyer_1500",  category: "投函枚数", catIcon: "📮", rank: 3, icon: "📦", label: "ポスタリスト",     desc: "累計1,500枚投函",  color: "#9ca3af", check: s => s.totalFlyers >= 1500 },
  { id: "flyer_3000",  category: "投函枚数", catIcon: "📮", rank: 4, icon: "🚀", label: "投函マシーン",     desc: "累計3,000枚投函",  color: "#f59e0b", check: s => s.totalFlyers >= 3000 },
  { id: "flyer_6000",  category: "投函枚数", catIcon: "📮", rank: 5, icon: "🌟", label: "レジェンド配達人", desc: "累計6,000枚投函",  color: "#a855f7", check: s => s.totalFlyers >= 6000 },
  { id: "flyer_15000", category: "投函枚数", catIcon: "📮", rank: 6, icon: "👑", label: "投函王",           desc: "累計15,000枚投函", color: "#ec4899", check: s => s.totalFlyers >= 15000 },
  // 制覇市区町村数（5段階）
  { id: "conq_1",  category: "市区町村制覇", catIcon: "🏙️", rank: 1, icon: "🏁", label: "第一歩",         desc: "1市区町村制覇",  color: "#94a3b8", check: s => s.conquest >= 1 },
  { id: "conq_3",  category: "市区町村制覇", catIcon: "🏙️", rank: 2, icon: "🗺️", label: "エリア探検家",   desc: "3市区町村制覇",  color: "#cd7f32", check: s => s.conquest >= 3 },
  { id: "conq_7",  category: "市区町村制覇", catIcon: "🏙️", rank: 3, icon: "🏙️", label: "タウンマスター", desc: "7市区町村制覇",  color: "#9ca3af", check: s => s.conquest >= 7 },
  { id: "conq_15", category: "市区町村制覇", catIcon: "🏙️", rank: 4, icon: "🌆", label: "シティハンター",  desc: "15市区町村制覇", color: "#f59e0b", check: s => s.conquest >= 15 },
  { id: "conq_30", category: "市区町村制覇", catIcon: "🏙️", rank: 5, icon: "🗾", label: "北関東の覇者",    desc: "30市区町村制覇", color: "#ec4899", check: s => s.conquest >= 30 },
  // 開拓者回数（5段階）
  ...
  // 活動日数（5段階）
  { id: "days_1",  category: "活動日数", catIcon: "📅", rank: 1, icon: "🌱", label: "初陣",       desc: "1日間活動",  color: "#94a3b8", check: s => s.activeDays >= 1 },
  { id: "days_3",  category: "活動日数", catIcon: "📅", rank: 2, icon: "🔥", label: "コツコツ隊員", desc: "3日間活動",  color: "#cd7f32", check: s => s.activeDays >= 3 },
...
const CHANGELOG = [
  {
    date: "2026-04-24",
    updates: [
      { text: "市区町村別ランキングを追加（投函数・投函率・投函人数）" },
      { text: "バッジタブに配布エリアマップ追加" },
      { text: "🎉 累計投函数 40,000枚突破！" },
    ],
  },
  {
    date: "2026-04-22",
  ...
  },
  {
    date: "2026-04-07",
    updates: [
      { text: "手を動かす宣言機能を追加（未配布市区町村の担当宣言・有言実行バッジ）" },
      { text: "宣言中エリアを地図上で紫ストライプ表示" },
    ],
  },
  {
    date: "2026-03-27",
    updates: [
      { text: "🎉 累計投函数 20,000枚突破！" },
      { text: "日次バックアップ機能を導入" },
